...
The link:https://python.langchain.com/v0.2/docs/integrations/vectorstores/neo4jvector/[`Neo4jVector`^] is a Langchain vector store that uses a Neo4j database as the underlying data structure.
